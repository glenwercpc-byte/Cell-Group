...
function renderMonthlyForm(){
  ...
  body.innerHTML='<div style="border:1.5px solid #1a2744;border-radius:4px;overflow:hidden;margin-bottom:10px"><table style="width:100%;border-collapse:collapse;background:#e8edf7"><tr style="font-size:.77rem;font-weight:700;color:#1a2744"><td style="padding:6px 10px;border:1px solid #b8c8e0">샘터</td><td style="padding:6px 10px;border:1px solid #b8c8e0;font-weight:800">'+sNum+'</td><td style="padding:6px 10px;border:1px solid #b8c8e0">청지기</td><td style="padding:6px 10px;border:1px solid #b8c8e0">'+(samter?.keeper||'')+'</td><td style="padding:6px 10px;border:1px solid #b8c8e0">지구장</td><td style="padding:6px 10px;border:1px solid #b8c8e0">'+getDistrictChief(sNum)+'</td><td style="padding:6px 10px;border:1px solid #b8c8e0">총원</td><td style="padding:6px 10px;border:1px solid #b8c8e0">'+total+'명</td><td style="padding:6px 10px;border:1px solid #b8c8e0">참석</td><td id="att-count-cell" style="padding:6px 10px;border:1px solid #b8c8e0;font-weight:700;color:#2d6a4f">'+attCount+'명</td><td style="padding:6px 10px;border:1px solid #b8c8e0">출석률</td><td id="att-rate-cell" style="padding:6px 10px;border:1px solid #b8c8e0;font-weight:700;color:#3a5a8c">'+rate+'%</td></tr></table><div style="display:grid;grid-template-columns:1fr 1fr;border-top:1px solid #ddd"><div><div style="display:grid;grid-template-columns:42px 0.5fr 44px 1.5fr;background:#3a5a8c;color:#fff;font-size:.73rem"><span style="padding:5px;text-align:center;border-right:1px solid rgba(255,255,255,.2)">번호</span><span style="padding:5px;text-align:center;border-right:1px solid rgba(255,255,255,.2)">성명</span><span style="padding:5px;text-align:center;border-right:1px solid rgba(255,255,255,.2)">출결</span><span style="padding:5px;text-align:center">결석사유</span></div>'+mkRows(members.slice(0,half),0)+'</div><div style="border-left:1px solid #ddd"><div style="display:grid;grid-template-columns:42px 0.5fr 44px 1.5fr;background:#3a5a8c;color:#fff;font-size:.73rem"><span style="padding:5px;text-align:center;border-right:1px solid rgba(255,255,255,.2)">번호</span><span style="padding:5px;text-align:center;border-right:1px solid rgba(255,255,255,.2)">성명</span><span style="padding:5px;text-align:center;border-right:1px solid rgba(255,255,255,.2)">출결</span><span style="padding:5px;text-align:center">결석사유</span></div>'+mkRows(members.slice(half),half)+'</div></div><table style="width:100%;border-collapse:collapse"><tr><td style="border:1px solid #ddd;padding:5px 8px;background:#f0f3f8;font-size:.75rem;font-weight:600;width:70px">새교우</td><td style="border:1px solid #ddd;padding:5px"><input id="mr-new" type="text" style="border:none;width:100%;font-family:inherit;font-size:.75rem;outline:none" value="'+(saved['_new']||'')+'"></td></tr><tr><td style="border:1px solid #ddd;padding:5px 8px;background:#f0f3f8;font-size:.75rem;font-weight:600">보고사항</td><td style="border:1px solid #ddd;padding:5px"><input id="mr-report" type="text" style="border:none;width:100%;font-family:inherit;font-size:.75rem;outline:none" value="'+(saved['_report']||'')+'"></td></tr><tr><td style="border:1px solid #ddd;padding:5px 8px;background:#f0f3f8;font-size:.75rem;font-weight:600">건의사항</td><td style="border:1px solid #ddd;padding:5px"><input id="mr-suggest" type="text" style="border:none;width:100%;font-family:inherit;font-size:.75rem;outline:none" value="'+(saved['_suggest']||'')+'"></td></tr></table></div>';
